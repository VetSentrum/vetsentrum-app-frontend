...
export type ConsultaConRelaciones = ConsultaFormData & {
  folio?: number
  mascota?: {
    nombre: string
    raza?: string
...
/**
 * Documento imprimible de una consulta. Layout compartido por la página de
 * impresión (`/consultas/[id]`) y por la exportación de expediente en ZIP, para
 * que ambos generen el mismo PDF.
 */
export const DocumentoConsulta = forwardRef<HTMLDivElement, {
  consulta: ConsultaConRelaciones
  empresa: EmpresaDocumento | null
}>(function DocumentoConsulta({ consulta, empresa }, ref) {
