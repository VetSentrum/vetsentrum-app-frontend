...
export default function DefinirContrasenaForm() {
  ...
  return (
    <main className="max-w-md mx-auto mt-20 p-6 border rounded shadow">
      <h1 className="text-2xl font-semibold mb-6 text-center">Definir nueva contraseña</h1>
      ...
      {mensaje && <p className="mt-4 text-green-600 text-center font-medium">{mensaje}</p>}
